...
class Reader:
    ...
    def get_titles(self, url, days=1):
        ...
        try:
            ...
            print("Please check whether this machine can access https://arxiv.org or whether a global proxy/VPN is required.")
    ...
    def get_all_titles_from_web(self, keyword, page_num=1, days=1):
        ...
        if not title_list:
            print("No papers were collected from arXiv.")
            print("Possible reasons: the query returned no recent results, arXiv is unreachable from this machine, or a proxy/VPN is needed.")
        print("-" * 40)
...
def chat_arxiv_main(args):
    ...
    if not paper_list:
        print("No papers to summarize. Exiting early.")
        return
...
if __name__ == '__main__':
    ...
    parser.add_argument("--key_word", type=str, default='EEG emotion decoding, EEG foundation models, EEG decoding, time-series analysis, contrastive learning, transfer learning, knowledge distillation, domain adaptation, domain generalization', help="the key word of user research fields")
